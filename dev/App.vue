<template>
  <div id="app" :class="{ dark }">
    ...
    <div class="tabs-container">
      <RTab bordered moverFull ref="tabs" color="yellow">
    ...
    <div class="buttons">
      ...
      <RButton
        @click="notify('bottom-left', 'yellow')"
        icon="bx-border-radius"
        class="r-bl"
        iconOnlyAlt
        iconLarge
