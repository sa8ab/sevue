...
const FocusTrapProps = defineFocusTrapProps({
  ...
  clickOutsideDeactivates: [Boolean, Function] as PropType<Options["clickOutsideDeactivates"]>,

  initialFocus: [String, Function, Boolean] as PropType<Options["initialFocus"]>,
